                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="float-right d-none d-md-block">
                            <div class="dropdown">
                                <a href="{{ route('teacher.grades.add') }}" class="btn btn-light btn-rounded"
                                    type="button">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group">
                                                            <a href="{{ route('teacher.grade.detail', $row->id) }}"
                                                                type="button" class="btn btn-outline-secondary btn-sm"
                                                                data-toggle="tooltip" data-placement="top"
                                                                title="ເບິ່ງລາຍລະອຽດ">
                                                                <i class="mdi mdi-eye"></i>
                                                            </a>
                                                            <a href="{{ route('teacher.grade.edit', $row->id) }}"
                                                                type="button" class="btn btn-outline-secondary btn-sm"
                                                                data-toggle="tooltip" data-placement="top"
                                                                title="ແກ້ໄຂຂໍ້ມູນ">
