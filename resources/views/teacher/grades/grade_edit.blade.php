                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">ແກ້ໄຂຄະແນນ</li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-between px-2">
                                    <a href="{{ route('teacher.grade.detail', $editData->id) }}" class="btn rounded"><i
                                ...
                                <hr>
                                <form action="{{ route('teacher.grade.update', $editData->id) }}" method="POST">
                                    @csrf
