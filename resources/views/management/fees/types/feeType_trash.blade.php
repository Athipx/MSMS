        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title mb-1">ຖັງຂີ້ເຫຍື້ອ ປະເພດຄ່າທຳນຽມ</h4>
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="#">ວິຊາການ</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('feeTypes.view') }}">ຫ້ອງຮຽນ</a></li>
                            <li class="breadcrumb-item active">ຖັງຂີ້ເຫຍື້ອ ປະເພດຄ່າທຳນຽມ</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div>
                                    <a href="{{ route('feeTypes.view') }}" class="btn btn-light btn-rounded btn-sm mb-1"><i
                                                ...
                                                <div class="card card-body" style="background: #f4f8f9;">
                                                    <div class="d-flex justify-content-between align-items-center"
                                                        ...
                                                        <h5 class="card-title" style="margin: 0; padding:0;">
                                                            {{ $item->type }}</h5>
                                                        <a href="{{ route('feeType.restore', $item->id) }}"
