...
@section('content')
    <title>ເພີ່ມການຊຳລະຄ່າຮຽນ</title>
    ...
    <div class="page-content">
        ...
        <div class="page-content-wrapper">
            <div class="container-fluid">
                <form method="post" action="{{ route('tutitions.store') }}" id="filter-form">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
    ...
    <script>
        $('#filter-form').on('click', '#search', function(event) {
            ...
            $.ajax({
                url: "{{ route('tutitions.getStudents') }}",
                type: 'GET',
                data: formData,
