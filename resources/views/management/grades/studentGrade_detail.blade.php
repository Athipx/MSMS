                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row d-flex justify-content-between px-2">
                                    <a href="{{ route('grades.view') }}" class="btn rounded"><i
                                            class="fas fa-arrow-left mr-2"></i>ກັບຄືນ</a>
                                    <a href="{{ route('grade.edit', $data->id) }}" type="button"
                                        class="btn btn-light btn-rounded waves-effect waves-light {{ !in_array(Auth::user()->role, ['teacher', 'admin']) ? 'd-none' : '' }}">
