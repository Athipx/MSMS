                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('studentProfile.update') }}" class="needs-validation"
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    <label>ເພດ<span class="text-danger">*</span></label>
                                                                    <div>
                                                                        <div
                                        ...
                                        <div class="row pt-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input name="phone"
                                                            ...
                                                            type="number" id="phone" placeholder="ປ້ອນເບີໂທລະສັບ..."
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input name="bd_major"
                                                            ...
                                                            type="text" id="bd_major" placeholder="ປ້ອນສາຂາທີ່ຈົບ..."
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select name="working_org" id="" class="form-control">
