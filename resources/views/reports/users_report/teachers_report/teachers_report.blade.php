        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title mb-1">ລາຍງານອາຈານ</h4>
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="#">ລາຍງານ</a></li>
                            <li class="breadcrumb-item active">ລາຍງານອາຈານ</li>
                        </ol>
                    </div>
                    {{-- <div class="col-md-4">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="GET" action="{{ route('teachers.report') }}" id="filter-form">
                                    <div class="row">
                                        <div class="col-md-9">
                                ...
                                <div class="card-body">
                                    <div id="filter-result">
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            ...
                                            <form action="{{ route('teachers.export') }}" method="get">
