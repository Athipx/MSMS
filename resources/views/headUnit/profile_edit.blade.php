                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('headUnit.dashboard') }}">ໜ້າຫຼັກ</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content p-3">
                                    ...
                                    <div class="tab-pane active" id="custom-home" role="tabpanel">
                                        <form method="post" action="{{ route('headUnit.profileUpdate') }}"
                                    ...
                                    <div class="tab-pane" id="custom-profile" role="tabpanel">
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-12">
                                                ...
                                                <form action="{{ route('headUnit.updatePwd') }}" method="post">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
