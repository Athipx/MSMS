...
<html lang="en">
    ...
    <head>
        ...
        <!-- datepicker -->
        <link href="{{asset('theme/assets/libs/air-datepicker/css/datepicker.min.css')}}" rel="stylesheet" type="text/css" />
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="form-group mt-5">
                                                            ...
                                                            <input type="text" id="show-alpha" value="rgba(240, 101, 67, 0.5)">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="#">
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" class="form-control datepicker-here" data-language="en" data-multiple-dates="3" data-multiple-dates-separator=", " data-position='top left'/>
                                                </div>
                                                <div class="form-group mb-4">
                                                    <label>Month selection</label>
                                                    <input type="text" class="form-control datepicker-here" data-min-view="months" data-view="months" data-date-format="MM yyyy" data-language="en" />
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group mb-4">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <input type="text" class="form-control datepicker-here" data-timepicker="true" data-language="en" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
