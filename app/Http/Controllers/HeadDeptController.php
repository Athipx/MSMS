...
class HeadDeptController extends Controller
{
    public function index()
    {
        ...
        return view('headDept.index', $data, compact('students'));
    }
    ...
    public function ProfileDetail()
    {
        ...
        return view('headDept.profile', compact('UserData'));
    }
    ...
    public function ProfileEdit()
    {
        ...
        return view('headDept.profile_edit', compact('editData'));
    }
