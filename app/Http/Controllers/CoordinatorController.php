...
class CoordinatorController extends Controller
{
    public function index()
    {
        ...
        $data['allUnpaidFees'] = StudentFee::where('status', 'unpaid')->get();
        $data['allUnpaidTutitions'] = Tutition::where('status', 'unpaid')->get();
        $data['allInstallments'] = Tutition::where('status', 'installment')->get();
        ...
        return view('coordinator.index', $data, compact('students'));
    }
    ...
    public function ProfileDetail()
    {
        ...
        return view('coordinator.profile', compact('UserData'));
    }
    ...
    public function ProfileEdit()
    {
        ...
        return view('coordinator.profile_edit', compact('editData'));
    }
